...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('ket-qua-tim-kiem','PageController@search')->name('search_result');
    ...
    Route::get('flash-sale.html', 'PageController@flashSale')->name('flashSale');
    ...
    Route::get('get-data-cart', 'CartController@getDataCart')->name('getDataCart');
