                                    ...
                                    <td class="product-image">
                                        <div class="product-thumbnail">
                                            <div class="product-thumbnail-wrapper">
                                                <img class="product-thumbnail-image" alt=" {{ languageName($details['name']) }}"
                                                     src="{{ url(''.$details['image']) }}" />
                                            </div>
                                            <span class="product-thumbnail-quantity" aria-hidden="true">{{ $details['quantity'] }}</span>
                                        </div>
                                    </td>
                                    <td class="product-description">
                                        <span class="product-description-name order-summary-emphasis">{{ languageName($details['name']) }}</span>
                                    </td>
                                    <td class="product-quantity visually-hidden">{{ $details['quantity'] }}</td>
                                    <td class="product-price">
                                        <span class="order-summary-emphasis">{{ number_format($details['price'] - ($details['price']*($details['discount']/100))) }}₫</span>
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="main-content">
                ...
                <div class="step">
                                ...
                                <div class="fieldset">
                                    ...
                                    <div class="field   ">
                                        <div class="field-input-wrapper">
                                            ...
                                            <input placeholder="Họ và tên" autocapitalize="off" spellcheck="false" required
                                                   class="field-input" size="30" type="text" id="billing_address_full_name"
                                                   name="billingName" value=""  autocomplete="false"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field field-required field-third  ">
                                        <div class="field-input-wrapper">
                                            ...
                                            <input autocomplete="false" placeholder="Số điện thoại" autocapitalize="off"  required
                                    ...
                                    <div class="field">
                                        <div class="field-input-wrapper">
                                            ...
                                            <input placeholder="Địa chỉ nhận hàng" autocapitalize="off" spellcheck="false" required
                    ...
                    <div class="step-footer" >
                        ...
                        <a class="step-footer-previous-link" href="{{route('listCart')}}">
                            Giỏ hàng
                        </a>
                    </div>
                    </form>
